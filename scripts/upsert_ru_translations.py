...
ARTICLE_RU: dict[str, dict[str, str]] = {
    "france-names-world-cup-squad-risser": {
    ...
    "brazil-ancelotti-extends-2030-world-cup": {
    ...
    "metlife-final-natural-grass-installation": {
    ...
    "seattle-world-cup-transit-plan": {
    ...
    "mexico-city-azteca-world-cup-guide": {
    ...
    "world-cup-final-halftime-show-lineup": {
